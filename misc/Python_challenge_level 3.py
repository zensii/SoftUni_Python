...
'''
string ='mystring to check for matches'
message = ''
for index in range(len(string)-7):
    if (string[index:index+7].isalpha() and string[index:index+3].isupper() and string[index+3].islower() and
            string[index+4:index+7].isupper() and (string[index-1].islower() or not string[index-1].isalpha()) and
            (string[index+7].islower() or not string[index+7].isalpha())):
